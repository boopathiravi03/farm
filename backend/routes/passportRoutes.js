    ...
    try {
      ...
      if (
        ...
        return res.status(403).json({
          success: false,
          message:
            "You can only create passports for your crops",
        });
      }

      // Check existing passport
      const existing =
        await CropPassport.findOne({
          crop: cropId,
        });
